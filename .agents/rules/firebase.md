...
4. **Sincronização de Schema**: Toda alteração no Firebase que impacte o estado do usuário deve ser seguida por um `syncUserAction` ou semelhante para manter o SupabaseDB atualizado conforme o padrão "Sanduíche".
