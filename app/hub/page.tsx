...
export default function ProfilePage() {
    ...
    const mockUser = {
        ...
        joinDate: "Membro desde Junho de 2026",
    };
    ...
    return (
        <div>
            <Header title="Meu Perfil" showSubHeader={false} />
            <main className="container flex justify-center items-start pt-6">
                <div className="card p-6 md:p-8 w-full max-w-lg flex flex-col gap-6">
                    ...
                    <div className="flex flex-col items-center gap-4 text-center border-b border-border/40 pb-6">
                        <div className="h-24 w-24 rounded-full bg-linear-to-tr from-violet-500 to-indigo-500 flex items-center justify-center text-white text-3xl font-bold shadow-xs">
                            {initials}
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-3 text-muted-foreground">
                            ...
                            <div className="flex flex-col text-left">
                                ...
                                <span className="text-sm font-medium text-foreground">{mockUser.joinDate}</span>
                            </div>
                        </div>
                    </div>
                </div>
